...
function App() {
  const GOOGLE_CLIENT_ID = "YOUR_GOOGLE_CLIENT_ID_HERE.apps.googleusercontent.com"; // TODO: Replace
    ...
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      <ToastProvider>
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["ADMIN", "HR", "PM", "EMPLOYEE"]}>
              <MainLayout><TeamList /></MainLayout>
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["ADMIN", "HR", "PM", "EMPLOYEE"]}>
              <MainLayout><TeamDetails /></MainLayout>
            </ProtectedRoute>
          }
        />
